    ...
    return Column(
      children: [
        ...
        ServiceCard(
          ...
          name: 'Handphone New Galaxy Z f6',
          role: 'Electronik',
          description:
              'Nikmati Upgrade Memori Gratis dari 256GB ke 512GB & Benefit Lainnya Hingga Rp3,6jt. Kamera 50MP. Baterai 4000 mAh..',
          rating: 4.9,
        ),
        ServiceCard(
          ...
          role: 'Electronic',
          description: 'Pilihan Laptop keluaran terbaru & terlengkap.',
          rating: 4.9,
        ),
        ServiceCard(
          imageUrl: 'assets/images/tablet2.jpg',
          name: 'Samsung Galaxy Tablet',
          role: 'Electronic',
          description: 'Pilihan Tablet bergaransi resmi terlengkap & terbaru..',
          rating: 4.9,
        ),
      ],
    );
    ...
    return Column(
      children: [
        BestBookingCard(
          ...
          profileUrl: 'assets/images/pc2.jpg',
          name: 'Rekomendasi Barang Elektronik',
          role: 'Electronic',
          description:
              'Tersedia berbagai macam barang electronic dari laptop, pc, hp, kamera dan lainnya .',
          rating: 4.9,
        ),
            ...
            Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/adakmra.jpg', // Ganti dengan path gambar Anda
                    height: 230,
                    width: double.infinity,
                    fit: BoxFit.cover,
                  ),
